...
class KineticScrolling extends Phaser.Plugins.ScenePlugin{
    ...
    moveCamera(pointer) {
        ...
        // console.log('pointerOverCamera = true');
        // this.pointerOverCamera = true;
    ...
    */
    ...
    endMove(pointer) {
        ...
        // проверка что указатель над камерой
        ...
        // if (!over) {
        //     // // для работы скролла мыши
        //     // console.log('pointerOverCamera = false');
        //     // this.pointerOverCamera = false;
