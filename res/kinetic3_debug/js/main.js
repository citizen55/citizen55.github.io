...
class KineticScrolling extends Phaser.Plugins.ScenePlugin{
    ...
    beginMove(pointer) {
        this.scene.debugText('kinetic beginMove()  pointer.id: ' + pointer.id);
    ...
    */
    ...
    endMove(pointer) {
        ...
        this.scene.debugText('kinetic endMove()  pointer.id: ' + pointer);
        ...
        clearTimeout(this.timerDown);
        this.kineticDown = false;
        this.scene.debugText('kinetic: kineticUp endMove');
        this.scene.input.emit('kineticUp');
        this.scene.debugText('kinetic: kineticClick endMove');
        this.scene.input.emit('kineticClick');
        this.scene.debugText('kinetic: kineticOff endMove');
        this.scene.input.emit('kineticOff');
    ...
    */
    ...
    addInteractive(gameobject){
        ...
        gameobject.on('pointerdown', function(pointer){
            this.bottom.debugText('\npointerdown  subscribe box on kinetic events  ptr.x: ' + pointer.x + ' ptr.y: ' + pointer.y);
            this.bottom.debugText('box' + this.name + ' x: ' + this.x + ' y: ' + this.y);
            ...
            this.scene.input.on('kineticOff', function(){
                this.bottom.debugText('kineticOff: function off() ');
                this.onKineticDown != undefined && 
